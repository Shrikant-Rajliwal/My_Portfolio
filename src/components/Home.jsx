...
const Home =()=>{
    ...
    const web2Ref = useRef()

    useGSAP(()=>{
        gsap.fromTo(pieRef.current,
            { y: '0%', opacity: 1 }, // Start from above the viewport
            { y: '-80%', opacity: 1, duration: 1.3 ,repeat: -1,    // Infinite loop
                yoyo: true  }
        )
    })
    useGSAP(()=>{
        gsap.fromTo(triangleRef.current,
            { y: '-20%', opacity: 1 }, // Start from above the viewport
            { y: '50%', opacity: 1, duration: 1.6 ,repeat: -1,    // Infinite loop
                yoyo: true  }
        )
    })
    useGSAP(()=>{
        gsap.fromTo(squareRef.current,
            { y: '20%', opacity: 1 }, // Start from above the viewport
            { y: '-90%', opacity: 1, duration: 1 ,repeat: -1,    // Infinite loop
                yoyo: true  }
        )
    })
    useGSAP(()=>{
        gsap.fromTo(circleRef.current,
            { y: '0%', opacity: 1 }, // Start from above the viewport
            { y: '-110%', opacity: 1, duration: 1.3 ,repeat: -1,    // Infinite loop
                yoyo: true  }
        )
    })
    useGSAP(()=>{
        gsap.fromTo(textRef.current,
            { y: '0%', opacity: 0 }, // Start from above the viewport
            { y: '-110%', opacity: 1, duration: 1.3 , 
                scrollTrigger: {
                    trigger: svg1Ref.current,
                    start: "top 110%",
                    end: "bottom 50%",
                    scrub: true,
                  },    // Infinite loop
    ...
    useGSAP(()=>{
        gsap.fromTo(svg1Ref.current,
            { x: '-110%', opacity: 0.3 }, // Start from above the viewport
...
<Navbar />
            ...
            <div className="w-full h-auto bg-gray-950 p-4 pt-20 lg:pt-36 overflow-hidden  ">
                <div className="md:flex justify-center items-center md:mb-40 lg:mb-52">
                    <div className="text-white flex flex-col gap-3 sm:mb-0 lg:pl-10 xl:pl-16  ">
                        <h1 className="text-3xl lg:text-5xl">Hello.</h1>
                        <p className="w-4/4 lg:w-3/4 text-lg lg:text-xl">I'm <span className="text-red-500">Shrikant Rajliwal</span>, a Full Stack Developer with experience in creating dynamic and responsive web applications.</p>

                            <div className="flex gap-4 text-3xl">
                                <a target="_blank" href="https://github.com/Shrikant-Rajliwal"> <FaGithub /></a>
